...
module UnobtrusiveJavascript::Helpers
  include UnobtrusiveJavascript::BehaviourHelper
  include UnobtrusiveJavascript::JavascriptProxies
  ...
  def apply_behaviours(&block)
    BehaviourMapper.new(self).instance_eval &block
  end
  ...
  protected
    ...
    def element_proxy(generator)
      UnobtrusiveJavascript::JavascriptProxies::JavascriptArgumentProxy.new(ActionView::Helpers::JavaScriptVariableProxy, generator, 'this')
    end
    
    # Returns a new JavascriptArgumentProxy for the event the behaviour has
    # been applied to.
    def event_proxy(generator)
      UnobtrusiveJavascript::JavascriptProxies::JavascriptArgumentProxy.new(UnobtrusiveJavascript::JavascriptProxies::JavascriptEventProxy, generator, 'event')
    end

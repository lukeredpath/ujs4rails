...
class BehaviourGenerationWithNoBehavioursTest < Test::Unit::TestCase
  def setup
    ...
    UnobtrusiveJavascriptController.any_instance.stubs(:js_behaviours).returns(UnobtrusiveJavascript::BehaviourScript.new)
    get :generate
  end
...
class BehaviourGenerationWithAppliedBehavioursTest < Test::Unit::TestCase
  def setup
    @behaviours = UnobtrusiveJavascript::BehaviourScript.new
